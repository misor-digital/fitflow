        ...
        return (
          <div>
            ...
            <div className="space-y-3 sm:space-y-4 md:space-y-5">
              {[
                { value: true, title: 'Да, искам персонализация', desc: 'Персонализацията включва няколко въпроса, които ни помагат по-добре да разберем твоите предпочитания и нужди' },
