...
const faqs = [
  ...
  },
  {
    ...
    answer: 'При еднократна покупка ще получиш кутия до 5 работни дни от потвърждаване на поръчката. Ако избереш абонаментен план, ще получаваш кутията си в началото на месеца, между 15-то и 20-то число.'
  },
  {
