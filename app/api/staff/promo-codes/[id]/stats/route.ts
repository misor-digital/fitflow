/**
 * API Route: Promo Code Statistics
 * GET /api/staff/promo-codes/[id]/stats - Get usage statistics for a promo code
 */

import { NextRequest, NextResponse } from 'next/server';
import { createClient } from '@supabase/supabase-js';
import { hasAnyRole } from '@/lib/supabase/staffService';
import { getPromoCodeStats } from '@/lib/supabase/promoService';
...
export async function GET(
  ...
  try {
    ...
    const result = await getPromoCodeStats(id);
