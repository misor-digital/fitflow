/**
 * API Route: Promo Code Usage Analytics
 * GET /api/staff/analytics/promo-codes - Get promo code usage statistics
 */

import { NextRequest, NextResponse } from 'next/server';
import { createClient } from '@supabase/supabase-js';
import { hasAnyRole } from '@/lib/supabase/staffService';
import { getPromoCodeUsage } from '@/lib/supabase/analyticsService';
...
export async function GET(request: NextRequest) {
  try {
    ...
    const result = await getPromoCodeUsage();
