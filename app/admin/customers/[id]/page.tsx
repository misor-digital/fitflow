            ...
            {subscriptions.map((sub: SubscriptionRow) => {
              ...
              return (
                ...
                >
                  ...
                  <p className="text-xs text-gray-400 font-mono mb-1">{sub.subscription_number}</p>
                      ...
                      return (
                        <tr key={order.id} className="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                          ...
                          <td className="px-4 py-3 text-gray-500 text-xs">
                            {order.delivery_method === 'speedy_automat' ? 'Speedy автомат' : order.delivery_method === 'speedy_office' ? 'Speedy офис' : 'До адрес'}
                          </td>
