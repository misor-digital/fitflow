...
export default function CustomerRegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!response.ok) {
        setError(data.error?.message || 'Грешка при регистрация');
        setLoading(false);
        return;
      }

      // Successful registration - redirect to account dashboard
      router.push('/account');
      router.refresh();
    } catch {
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-600 via-blue-700 to-blue-900 flex items-center justify-center px-4 py-12">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-blue-200">Създаване на профил</p>
        </div>
